...
<div class="container mb-4 text-center" style="padding-bottom: 6rem;">
	...
	<a href="./workspaces/" class="btn btn-primary m-2 p-3 px-4" style="height: 3rem;"><i class="fa fa-building fa-lg"></i> Crear Workspaces</a>
	<a href="./sections/" class="btn btn-primary m-2 p-3 px-4" style="height: 3rem;"><i class="fa fa-home fa-lg"></i> Crear Oficinas</a>
	<a href="./employees/" class="btn btn-warning m-2 p-3 px-4" style="height: 3rem;"><i class="fa fa-users fa-lg "></i> Empleados</a>
...
<?php
 ...
 if( $t->descripcion == "admin"):?>
	<a href="./users/" class="btn btn-dark m-2 p-3" style="height: 3rem;"><i class="fa fa-user fa-lg"></i> Usuarios</a>
