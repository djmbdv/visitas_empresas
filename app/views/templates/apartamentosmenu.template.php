...
<div class="row m-4 pb-4">
	<div class="col">
<a href="./apartamentos/workspace" class="btn btn-primary btn-block p-3 mt-4"><i class="fa fa-building fa-lg fa-3x m-2"></i><b style="font-size: 1.5rem;">Por workspace</b></a>
</div>
	<div class="col">
